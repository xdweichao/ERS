...
public class TicketCreator {
	...
	public TicketCreator(int ticketid, double amount, Timestamp datesubmitted, Timestamp dateresolved, String description,
			String receipt, String author, int resolverid, int statusid, int typeid) {
		super();
	...
	public String toString() {
		return "Tickets [ticketid=" + ticketid + ", amount=" + amount + ", datesubmitted=" + datesubmitted
				...
				+ ", author=" + author + ", resolverid=" + resolverid + ", statusid=" + statusid + ", typeid="
				+ typeid + "]";
	}
